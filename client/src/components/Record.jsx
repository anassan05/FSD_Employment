  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const response = await fetch(
        `https://fsd-employment.onrender.com/record/${params.id.toString()}`
      );
      if (!response.ok) {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      if (isNew) {
        ...
        response = await fetch("https://fsd-employment.onrender.com/record", {
          method: "POST",
          headers: {
        ...
        response = await fetch(`https://fsd-employment.onrender.com/record/${params.id}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      <form onSubmit={onSubmit} className="record-card">
        <div className="record-card-grid">
          ...
          <div className="record-fields">
            ...
            <div>
              <fieldset className="record-options">
